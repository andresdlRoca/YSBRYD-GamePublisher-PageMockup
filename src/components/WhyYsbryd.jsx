...
export default function WhyYsbryd() {
    ...
    return (
        <div className="whyysbryd">
            <div className="TitleLabels">WHY YSBRYD?</div>
            <div className="subtitlewhy"><span>DISCOVERY</span> IS THE MAGIC WORD. THE SPIRIT OF DISCOVERY REIGNS SUPREME IN THE WORLD OF INDIE GAME DEVELOPMENT - IF NOT <span>LET'S MAKE IT SO.</span></div>
            <p>We’ve seen lots of hopeful indie devs get derailed on their journey to make the game they’ve dreamed of. Financial floundering, unmanageable scopes, ineffectual marketing… We’ve walked that road of hardship ourselves.</p>
