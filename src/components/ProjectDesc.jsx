    ...
    return(
        <div className={selectedgame!="" ? "project-wrap visibleproject" : "nonvisibleproject"}>
            ...
            <div className="carrouselwrap">
                <Carousel className={selectedgame=="vallhalla" ? "vallhallacarrousel visibleproject" : "nonvisibleproject"} showIndicators={false} showThumbs={false} showStatus={false} autoPlay={true} infiniteLoop={true}>
                ...
                <Carousel className={selectedgame=="yiik" ? "YIIKcarrousel visibleproject" : "nonvisibleproject"} showIndicators={false} showThumbs={false} showStatus={false} autoPlay={true} infiniteLoop={true}>
                    <div><img src={YIIKthumb1} alt="YIIK 1"/></div>
                    <div><img src={YIIKthumb2} alt="YIIK 2"/></div>
                    <div><img src={YIIKthumb3} alt="YIIK 3"/></div>
                </Carousel>
                <Carousel className={selectedgame=="woh" ? "WOHcarrousel visibleproject" : "nonvisibleproject"} showIndicators={false} showThumbs={false} showStatus={false} autoPlay={true} infiniteLoop={true}>
                    <div><img src={WOHthumb1} alt="WOH 1"/></div>
                    <div><img src={WOHthumb2} alt="WOH 2"/></div>
                    <div><img src={WOHthumb3} alt="WOH 3"/></div>
                </Carousel>
                <Carousel className={selectedgame=="noplace" ? "noplacecarrousel visibleproject" : "nonvisibleproject"} showIndicators={false} showThumbs={false} showStatus={false} autoPlay={true} infiniteLoop={true}>
                ...
                <Carousel className={selectedgame=="masquerada" ? "masqueradacarrousel visibleproject" : "nonvisibleproject"} showIndicators={false} showThumbs={false} showStatus={false} autoPlay={true} infiniteLoop={true}>
                ...
                <Carousel className={selectedgame=="nirvanna" ? "nirvannacarrousel visibleproject" : "nonvisibleproject"} showIndicators={false} showThumbs={false} showStatus={false} autoPlay={true} infiniteLoop={true}>
                ...
                <Carousel className={selectedgame=="sheremebered" ? "srccarrousel visibleproject" : "nonvisibleproject"} showIndicators={false} showThumbs={false} showStatus={false} autoPlay={true} infiniteLoop={true}>
            ...
            <div className="projectdescwrap">
                ...
                <div className={selectedgame=="vallhalla" ? "vallhalladesc visibleproject" : "nonvisibleproject"}>
                    ...
                    <p className="textdesc">Developer: <a href="http://sukeban.moe" id="developerlink">Sukeban Games</a> (http://sukeban.moe)<br/>Platforms: PC/Mac/Linux, PS Vita<br/>Release Date: Available Now</p>
                    <p className="projectdesctitle">Project Details</p>
                    <p className="textdesc"><span id="bold">Tags: </span>Linux, Mac, PC, PS4, Switch</p>
                ...
                <div className={selectedgame=="yiik" ? "YIIKdesc visibleproject" : "nonvisibleproject"}>
                    ...
                    <p className="textdesc">Developer: <a href="http://www.ackkstudios.com/" id="developerlink">Ackk Studios</a><br/>Platforms: PC/Mac/Linux, PS4, PS Vita, Nintendo Switch<br/>Release Date: This Winter</p>
                </div>
                <div className={selectedgame=="woh" ? "WOHdesc visibleproject" : "nonvisibleproject"}>
                    ...
                    <p className="textdesc">Developer: <a href="http://www.wohgame.com/" id="developerlink">panstasz</a><br/>Release Date: Available Now (Switch TBA)</p>
                ...
                <div className={selectedgame=="noplace" ? "noplacedesc visibleproject" : "nonvisibleproject"}>
                    ...
                    <p className="textdesc">Developer: Glitch Factory<br/>Platforms: Steam (Windows), Nintendo Switch<br/>Release Date: 2021</p>
                    <p className="projectdesctitle">Project Details</p>
                    <p className="textdesc"><span id="bold">Tags: </span>Consoles, Desktop, PC, Switch</p>
                </div>
                <div className={selectedgame=="masquerada" ? "masqueradadesc visibleproject" : "nonvisibleproject"}>
                    ...
                    <p className="textdesc">Developer: <a href="http://www.witching-hour.net/" id="developerlink">Witching Hour Studios</a><br/>Platforms: PC/Mac/Linux, PlayStation 4, Xbox One, Nintendo Switch<br/>Release Date: Available Now (Switch TBA)</p>
                    <p className="projectdesctitle">Project Details</p>
                    <p className="textdesc"><span id="bold">Tags: </span>Linux, Mac, PC, PS4, Switch, Xbox One</p>
                ...
                <div className={selectedgame=="nirvanna" ? "nirvannadesc visibleproject" : "nonvisibleproject"}>
                    ...
                    <p className="textdesc">Developer: <a href="http://sukeban.moe/" id="developerlink">Sukeban Games</a><br/>Platforms: Steam, PS4, Nintendo Switch<br/>Release Date: 2020 (Delayed)</p>
                    <p className="projectdesctitle">Project Details</p>
                    <p className="textdesc"><span id="bold">Tags: </span>Mac, PC, PS4, Switch</p>
                </div>
                <div className={selectedgame=="sheremebered" ? "srcdesc visibleproject" : "nonvisibleproject"}>
                    ...
                    <p className="textdesc">Developer: <a href="http://jumpsuit-entertainment.com/" id="developerlink">jumpsuit entertainment UG (haftungsbeschraenkt)</a><br/>Platforms: PC/Mac/Linux, Nintendo Switch, iOS<br/>Available Now</p>
                </div>
            </div>
        </div>
